...
--
-- Table structure for table `aggregate_filter_cameras`
--

DROP TABLE IF EXISTS `aggregate_filter_cameras`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aggregate_filter_cameras` (
...
--
-- Dumping data for table `aggregate_filter_cameras`
--

LOCK TABLES `aggregate_filter_cameras` WRITE;
/*!40000 ALTER TABLE `aggregate_filter_cameras` DISABLE KEYS */;
/*!40000 ALTER TABLE `aggregate_filter_cameras` ENABLE KEYS */;
UNLOCK TABLES;

...
DROP TABLE IF EXISTS `dm_price_change_cameras`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dm_price_change_cameras` (
  ...
  PRIMARY KEY (`sk`),
  KEY `dm_price_change_cameras_date_dim_sk_fk` (`date_sk`),
  CONSTRAINT `dm_price_change_cameras_date_dim_sk_fk` FOREIGN KEY (`date_sk`) REFERENCES `date_dim` (`sk`)
...
LOCK TABLES `dm_price_change_cameras` WRITE;
/*!40000 ALTER TABLE `dm_price_change_cameras` DISABLE KEYS */;
/*!40000 ALTER TABLE `dm_price_change_cameras` ENABLE KEYS */;
UNLOCK TABLES;

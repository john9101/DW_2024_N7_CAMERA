...
--
-- Table structure for table `aggregate_price_change_cameras`
--

DROP TABLE IF EXISTS `aggregate_price_change_cameras`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aggregate_price_change_cameras` (
...
--
-- Dumping data for table `aggregate_price_change_cameras`
--

LOCK TABLES `aggregate_price_change_cameras` WRITE;
/*!40000 ALTER TABLE `aggregate_price_change_cameras` DISABLE KEYS */;
/*!40000 ALTER TABLE `aggregate_price_change_cameras` ENABLE KEYS */;
UNLOCK TABLES;
